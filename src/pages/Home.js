...
import InstructionSection from '../component/core/Homepage/InstructionSection'
...
function Home() {
  return (
    <div>
        {/*Section 1 we use group in parent class so that jabh bhi ham button pe hover kre toh parent dark black ho */}
        ...
        <div className='bg-pure-greys-5 text-richblack-700 mt-10'>
            ...
            <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                <div className='flex flex-row gap-5 mb-10 mt-[95px] ml-[170px]'>
                    <div className='text-4xl font-semibold'>
        ...
        {/*Section 3 */}
        <div className='w-11/12 mx-auto max-w-maxContent flex-col items-center juustify-between gap-8 first-letter bg-richblack-900 text-white'>
            <InstructionSection/>
